 ...
 */
public class Van extends hasengine{

    public Van(String color, float price, int maxspeed, int weight, int travkm, int passengers, int fuelusage, int carryweight) throws Exception {
